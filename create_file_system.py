...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.entry_unit_format = ctk.CTkEntry(self, placeholder_text="Unit {0}", width=150)
        self.entry_unit_format.grid(column=0, row=7, padx=10, sticky=ctk.W)
        self.label_unit_format_tip = ctk.CTkLabel(self, text="({0} is the unit number)")
        ...
        self.entry_subunit_format = ctk.CTkEntry(self, placeholder_text="Unit {0}.{1}", width=150)
        self.entry_subunit_format.grid(column=1, row=7, padx=10, sticky=ctk.W)
        self.label_subunit_format_tip = ctk.CTkLabel(self, text="({0} is the unit number;\n{1} is the subunit number)")
    ...
    def _generate_dirs(self):
        ...
        root_name = self.entry_root_name.get() if (self.entry_root_name.get() != "") else self.entry_root_name.cget("placeholder_text")
